...
public class HistoryActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    int score= 0;
    int totalQuestion = HistoryBasicQ.HQuestions.length;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.historyques);
        ...
        submitBtn=findViewById(R.id.HisSubmit);
    ...
    public void onClick(View view) {
        ...
        if(clickedButton.getId()==R.id.HisSubmit) {
    ...
    void loadNewQuestion(){
        ...
        questionTextView.setText(HistoryBasicQ.HQuestions[currentQuestionIndex]);
        ansA.setText(HistoryBasicQ.HChoices[currentQuestionIndex][0]);
        ansB.setText(HistoryBasicQ.HChoices[currentQuestionIndex][1]);
        ansC.setText(HistoryBasicQ.HChoices[currentQuestionIndex][2]);
        ansD.setText(HistoryBasicQ.HChoices[currentQuestionIndex][3]);
    }
    void finishQuiz(){
        String passStatus= "";
        ...
        new AlertDialog.Builder(this)
                ...
                .setNegativeButton("Home", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        Intent a=new Intent(HistoryActivity.this,SecondActivity.class);
                        startActivity(a);
                    }
                })
                .show();
